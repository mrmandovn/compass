---
name: compass:commit
description: Smart commit — auto-generate conventional commit message from staged or changed files
allowed-tools:
  - Bash
  - Read
  - AskUserQuestion
...
Read and execute the workflow at `~/.compass/core/workflows/commit.md`.
